// User / hardware specific definitions for Wifi_LorA-32_V2 build.
// Copy from userdefines-example.h - edit as needed for your tube, logging, and transmission options.
